...
public:
	...
	void selection( TData<unsigned short> vetorDesordenado[], unsigned short tamanhoVetor )
	{
	...
	void trocarPosicaoValores( TData<unsigned short> *posicaoA, TData<unsigned short> *posicaoB )
	{
